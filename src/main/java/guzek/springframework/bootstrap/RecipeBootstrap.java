package guzek.springframework.bootstrap;

import guzek.springframework.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure teaSpoonUom = teaUomOptional.get();
        ...
        Category americanCategory = mexicanCategoryOptional.get();
        ...
        guacRecipe.setDirections("1. Cut Cuacamole, remove flash \n 2. Mash with a fork \n 3. Read more: www.siplyrecipes.com");

        Notes guacNotes = new Notes();
        guacNotes.setRecipeNotes("GO and find some notes a www.simpyrecipes.com for perfect guacamole");
